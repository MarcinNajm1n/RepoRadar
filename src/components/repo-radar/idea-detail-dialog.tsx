...
export function IdeaDetailDialog({
  ...
  const title = cleanDisplayText(idea.title, { maxLength: 180 });

  return (
    <DialogShell titleId={ideaDetailTitleId} onClose={onClose} className="max-w-4xl">
      <div className="sticky top-0 z-10 mb-4 flex items-start justify-between gap-3 border-b border-border-subtle bg-surface-overlay pb-4">
        <div>
          <h2 id={ideaDetailTitleId} className="text-xl font-semibold">
            {title}
          </h2>
